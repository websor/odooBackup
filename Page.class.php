...
static function menuILdetailed($typ, $invoices, $user, $type, $invoice_number, $customerSearch, $dateSearch, $salesOrderSearch, $count, $inv, $init, $totalPages, $page){ 
    $temp = $init + 50;
            ...
            <div class="row">
                    ...
                    <div class="content col-lg-9">
                        <form method="post">
                            ...
                            if($invoice_number == ""){ ?><input type="text" placeholder="Reference" name="invoiceNumberSearch" class="search_field"> <?php }else{ ?> <input type="text" value="<?php echo $invoice_number; ?>" disabled name="invoiceNumberSearch" class="search_field"> <input type="text" value="<?php echo $invoice_number; ?>" name="invoiceNumberSearch" style="display:none;" /> <?php } ?>
...
static function menuPLdetailed($typ, $invoices, $user, $type, $invoice_number, $customerSearch, $dateSearch, $salesOrderSearch, $count, $init, $totalPages, $page){
    $temp = $init + 50;
    if($temp < $count)
    {
        $finalNumber = $temp;
                                ...
                                { 
                                    ...
                                    { ?>
                                        ...
                                        <?php 
                                            ...
                                            <a href="menu-PLdetailed.php?typ=<?php echo $typ; ?>&user=<?php echo $user; ?>&type=<?php echo $type; ?>&page=<?php echo $i; ?>&skuSearch=<?php echo $salesOrderSearch; ?>&vendorSearch=<?php echo $customerSearch; ?>&productSearch=<?php echo $invoice_number; ?>&dateSearch=<?php echo $dateSearch; ?>"><div style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px; width:30px; text-align:center; float:left; margin:5px;">
                                                <?php echo $i; ?>
                                            </div></a>
                                        <?php
                                    }
...
static function menuPdetailed($typ, $invoices, $user, $type, $invoice_number, $customerSearch, $dateSearch, $salesOrderSearch, $count, $init, $totalPages, $page){ 
    $temp = $init + 50;
    if($temp < $count)
    {
        $finalNumber = $temp;
                                ...
                                { 
                                    ...
                                    { ?>
                                        ...
                                        <?php 
                                            ...
                                            <a href="menu-Pdetailed.php?typ=<?php echo $typ; ?>&user=<?php echo $user; ?>&type=<?php echo $type; ?>&page=<?php echo $i; ?>&skuSearch=<?php echo $invoice_number; ?>&vendorSearch=<?php echo $customerSearch; ?>&productSearch=<?php echo $dateSearch; ?>"><div style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px; width:30px; text-align:center; float:left; margin:5px;">
                                                <?php echo $i; ?>
                                            </div></a>
                                        <?php
                                    }
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12" style="text-align:center;">
                    ...
                    <div class="row center" style="width:95%; border-radius:10px; padding:30px; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
                        ...
                        <div class="col-lg-2">
                            <a href="menu-PLdetailed.php?user=<?php echo $user; ?>&typ=Purchase Line&type=<?php echo $typee; ?>&skuSearch=<?php echo $sku; ?>"><input type="button" value="Purchase History" name="goBack" class="btn btn-light" style="color:white; background:#0a3d67;" /></a>
                        </div>
                        <br><br><br><br><br><br>
                        <div class="col-lg-4">
                            <div>
