            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12" style="text-align:center;">
                    ...
                    <div class="row center" style="width:95%; border-radius:10px; padding:30px; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
                        ...
                        <div class="col-lg-2">
                            <a href="menu-ILdetailed.php?user=<?php echo $user; ?>&typ=<?php echo $typ; ?>&type=<?php echo $typee; ?>&item=<?php echo $product; ?>"><input type="button" value="Sales History" name="goBack" class="btn btn-light" style="color:white; background:#0a3d67;" /></a>
                        </div>
                        <div class="col-lg-2">
                            <a href="menu-PLdetailed.php?user=<?php echo $user; ?>&typ=<?php echo $typ; ?>&type=<?php echo $typee; ?>&item=<?php echo $sku; ?>"><input type="button" value="Purchase History" name="goBack" class="btn btn-light" style="color:white; background:#0a3d67;" /></a>
                        </div>
                        <br><br><br><br><br><br>
                        <div class="col-lg-4">
                            <div>
